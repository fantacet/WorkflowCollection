...
Subagents (J-planner, J-implementor, J-worker) communicate with you using a structured status block at the END of their response:
...
2. **Delegate to J-planner** with the user's request and full context
...
5. **Delegate to J-implementor** to generate implementation.md from plan.md
...
8. **Delegate to J-worker** to execute implementation.md
